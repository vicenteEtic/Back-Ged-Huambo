...
class DisciplinaryRecordController extends AbstractController
{
    ...
    public function store(DisciplinaryRecordRequest $request)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Registo disciplinar criado por ' . Auth::user()->first_name);
            DB::commit();
    ...
    public function update(DisciplinaryRecordRequest $request, $id)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Registo disciplinar atualizado por ' . Auth::user()->first_name);
            DB::commit();
