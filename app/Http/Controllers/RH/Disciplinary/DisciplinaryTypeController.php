...
class DisciplinaryTypeController extends AbstractController
{
    ...
    public function store(DisciplinaryTypeRequest $request)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Tipo disciplinar ' . $model->name . ' criado por ' . Auth::user()->first_name);
            DB::commit();
    ...
    public function update(DisciplinaryTypeRequest $request, $id)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Tipo disciplinar ' . $model->name . ' atualizado por ' . Auth::user()->first_name);
            DB::commit();
