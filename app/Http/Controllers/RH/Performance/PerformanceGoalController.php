...
class PerformanceGoalController extends AbstractController
{
    ...
    public function store(PerformanceGoalRequest $request)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Objectivo de desempenho criado por ' . Auth::user()->first_name);
            DB::commit();
    ...
    public function update(PerformanceGoalRequest $request, $id)
    {
        ...
        try {
            ...
            $this->logToDatabase(type: 'rh', level: 'info', customMessage: 'Objectivo de desempenho atualizado por ' . Auth::user()->first_name);
            DB::commit();
