...
use App\Jobs\GenerateAlertBeneficialJob;
...
class BeneficialService extends AbstractService
{
    ...
    public function createBeneficial(array $data, int $riskAssessmentId): void
    {
        foreach ($data['beneficial'] as $owner) {
            ...
            $beneficial =   $this->storeOrUpdate($dataBeneficial, $dataBeneficial);
            GenerateAlertBeneficialJob::dispatch($beneficial->id,   $dataBeneficial['risk_assessment_id'])
                ->onQueue('high');
